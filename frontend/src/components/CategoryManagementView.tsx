...
export const CategoryManagementView: React.FC = () => {
  ...
  // Sorting state
  const [sortField, setSortField] = useState<"name" | "code" | "courseCount">(
    "name",
  );
  ...
  const handleDelete = (id: number, name: string) => {
    if (
      confirm(
        `Are you sure you want to delete the category "${name}"? Courses associated with this category will remain, but their category label will need re-indexing.`,
      )
    ) {
      deleteCategory(id);
    }
    ...
    <div className="space-y-8 pb-12 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Organize and structure your curriculum with enterprise-grade
            taxonomy.
          </p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-4 bg-gray-50/50 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-4">
          <h3 className="text-lg font-bold text-gray-800 font-headline">
            Category List
          </h3>
              ...
              {filteredCategories.length > 0 ? (
                filteredCategories.map((cat) => {
                  ...
                  const maxCount = Math.max(
                    ...categories.map((c) => c.courseCount),
                  );
                  const percentage =
                    maxCount > 0 ? (cat.courseCount / maxCount) * 100 : 0;
                  ...
                  const renderIcon = () => {
                    ...
                    // FIX: Provide a fallback empty string if code is undefined
                    ...
                    >
                      <td className="px-6 py-4.5">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-gray-400 font-mono tracking-wider font-semibold mt-0.5">
                              Code: {cat.code}
                            </p>
                          </div>
                        </div>
                      ...
                      <td className="px-6 py-4.5">
                        <div className="flex items-center gap-3">
                          <span className="font-semibold text-xs text-gray-800 font-mono w-6">
                            {cat.courseCount}
                          </span>
                        ...
                        <div className="flex items-center gap-2">
                          {cat.status === "Active" ? (
                            <>
                              ...
                              <span className="text-xs font-medium text-[#006a62]">
                                Active
                              </span>
                            </>
                          ) : (
                ...
                <tr>
                  ...
                  >
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-sm">
                        No categories match your current search constraints.
                      </p>
                    </div>
                  </td>
                </tr>
        ...
        <div className="px-6 py-4 bg-gray-50/50 border-t border-gray-100 flex items-center justify-between text-xs text-gray-500">
          ...
          <div className="flex gap-1.5">
            <button
              className="px-3 py-1 bg-white border border-gray-200 rounded-lg text-gray-500 hover:bg-gray-50 cursor-not-allowed text-[11px]"
              disabled
            >
              Previous
            </button>
            <button className="px-3 py-1 bg-[#510047] text-white rounded-lg font-semibold text-[11px]">
              1
            </button>
            <button
              className="px-3 py-1 bg-white border border-gray-200 rounded-lg text-gray-500 hover:bg-gray-50 cursor-not-allowed text-[11px]"
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-sm text-white/80 leading-relaxed">
              Use our AI-powered auto-categorization tool to parse course
              descriptions and structure hundreds of curricular items instantly
              based on advanced keyword density analysis.
            </p>
          </div>
      ...
      {showSmartTagsToast && (
        <div className="fixed bottom-6 right-6 max-w-md bg-[#303030] text-white p-4 rounded-xl shadow-2xl border border-white/10 z-50 flex gap-3 animate-slide-up">
          ...
          <div>
            <p className="text-xs font-bold text-[#76f7e8]">
              AI Smart Tags Sync Completed
            </p>
            <p className="text-[11px] text-white/80 mt-1 leading-relaxed">
              Parsed 24 catalog courses. Standardized tag taxonomy for "DEV-01",
              "SEC-03", and matched 12 latent descriptions successfully.
            </p>
          </div>
        </div>
      )}
          ...
          <div className="bg-white w-full max-w-lg mx-4 rounded-3xl shadow-2xl border border-gray-100 overflow-hidden flex flex-col animate-scale-up">
            ...
            <div className="p-6 bg-gray-50 border-b border-gray-100">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Configure your curriculum taxonomy node fields below.
              </p>
            </div>
                    ...
                    (emoji) => (
                      <button
                        ...
                        className={`w-7 h-7 flex items-center justify-center rounded-lg border text-sm transition-all hover:bg-[#ffd7f0]/20 hover:scale-105 active:scale-95 ${
                          formData.icon === emoji
                            ? "border-[#510047] bg-[#ffd7f0]/10 font-bold"
